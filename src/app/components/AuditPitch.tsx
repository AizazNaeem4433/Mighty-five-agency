...
const AuditPitch: React.FC = () => {
  return (
    <section
      ...
      role="region"
      aria-label="Marketing Audit Pitch"
    >
      <motion.div
      ...
      >
        ...
        >
          ...
          <p className="text-gray-700 mb-6">
            ...
            <span className="font-bold">76% of marketing spend goes to waste</span>. We’ll show you
            where yours is leaking—and how to fix it fast.
          </p>
          ...
          <Link href="/contact">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded transition duration-300 cursor-pointer"
        ...
        >
          <Image
            src="/M.jpg"
            alt="Marketing audit visual"
            width={400}
            height={400}
            className="object-contain max-w-full h-auto rounded-xl shadow-lg"
          />
        </motion.div>
      </motion.div>
    </section>
